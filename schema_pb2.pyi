...
class Backup(_message.Message):
    __slots__ = ("backupManga", "backupCategories", "backupBrokenSources", "backupSources", "backupPreferences", "backupSourcePreferences")
    BACKUPMANGA_FIELD_NUMBER: _ClassVar[int]
    BACKUPCATEGORIES_FIELD_NUMBER: _ClassVar[int]
    BACKUPBROKENSOURCES_FIELD_NUMBER: _ClassVar[int]
    ...
    backupBrokenSources: _containers.RepeatedCompositeFieldContainer[BrokenBackupSource]
    ...
    def __init__(self, backupManga: _Optional[_Iterable[_Union[BackupManga, _Mapping]]] = ..., backupCategories: _Optional[_Iterable[_Union[BackupCategory, _Mapping]]] = ..., backupBrokenSources: _Optional[_Iterable[_Union[BrokenBackupSource, _Mapping]]] = ..., backupSources: _Optional[_Iterable[_Union[BackupSource, _Mapping]]] = ..., backupPreferences: _Optional[_Iterable[_Union[BackupPreference, _Mapping]]] = ..., backupSourcePreferences: _Optional[_Iterable[_Union[BackupSourcePreferences, _Mapping]]] = ...) -> None: ...

class BackupCategory(_message.Message):
    __slots__ = ("name", "order", "flags")
    ...
    order: int
    flags: int
    def __init__(self, name: _Optional[str] = ..., order: _Optional[int] = ..., flags: _Optional[int] = ...) -> None: ...
...
class BrokenBackupHistory(_message.Message):
    __slots__ = ("url", "lastRead", "readDuration")
    URL_FIELD_NUMBER: _ClassVar[int]
    LASTREAD_FIELD_NUMBER: _ClassVar[int]
    READDURATION_FIELD_NUMBER: _ClassVar[int]
...
class BackupManga(_message.Message):
    __slots__ = ("source", "url", "title", "artist", "author", "description", "genre", "status", "thumbnailUrl", "dateAdded", "viewer", "chapters", "categories", "tracking", "favorite", "chapterFlags", "brokenHistory", "viewer_flags", "history", "updateStrategy", "lastModifiedAt", "favoriteModifiedAt", "excludedScanlators", "version")
    ...
    BROKENHISTORY_FIELD_NUMBER: _ClassVar[int]
    ...
    favorite: bool
    chapterFlags: int
    brokenHistory: _containers.RepeatedCompositeFieldContainer[BrokenBackupHistory]
    viewer_flags: int
...
class BrokenBackupSource(_message.Message):
    __slots__ = ("name", "sourceId")
    NAME_FIELD_NUMBER: _ClassVar[int]
    SOURCEID_FIELD_NUMBER: _ClassVar[int]
    name: str
...
class BackupTracking(_message.Message):
    __slots__ = ("syncId", "libraryId", "mediaIdInt", "trackingUrl", "title", "lastChapterRead", "totalChapters", "score", "status", "startedReadingDate", "finishedReadingDate", "mediaId")
    ...
    mediaId: int
    def __init__(self, syncId: _Optional[int] = ..., libraryId: _Optional[int] = ..., mediaIdInt: _Optional[int] = ..., trackingUrl: _Optional[str] = ..., title: _Optional[str] = ..., lastChapterRead: _Optional[float] = ..., totalChapters: _Optional[int] = ..., score: _Optional[float] = ..., status: _Optional[int] = ..., startedReadingDate: _Optional[int] = ..., finishedReadingDate: _Optional[int] = ..., mediaId: _Optional[int] = ...) -> None: ...
